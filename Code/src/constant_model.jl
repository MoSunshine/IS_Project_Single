...
function calc_opt_model_linear(penalty,scenarios_full,possibility)
    ##constants for model
    net_revenue = [10 11 9 14;12 15 10 9;12 6 7 9;14 12 10 8]
    transfer_costs = [0 3 4 4;3 0 4 5; 4 4 0 6;4 5 6 0]
    ...
    println("DONE")
    return objective_value(cars), value.(x[1,1,:,:]), value.(y[1,1,:,:])
end
###main###
###Generate Scenarios###
...
for i in 1:10
    println(string("Current Price is: ", i*10) )
    revenue_v,x_1_v,y_1_v = calc_opt_model_linear(i*10,scenarios,possibility)
    push!(results_linear,revenue_v)
    push!(price,i*10)
    push!(x_1_values,x_1_v)
    push!(y_1_values,)
end
println(x_1_values[1])
println(y_1_values[1])